...
class MetaRecommender(nn.Module):
    ...
    def fix_hypernetwork(self, fix_only_user=True):
        ...
        if fix_only_user is False:
            self.hidden_layer_3.weight.requires_grad = False
            self.hidden_layer_3.bias.requires_grad = False

            self.emb_layer_1.weight.requires_grad = False
            self.emb_layer_2.bias.requires_grad = False

            self.emb_layer_2.weight.requires_grad = False
            self.emb_layer_2.bias.requires_grad = False
