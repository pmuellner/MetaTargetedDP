...
if __name__ == "__main__":
    ...
    CLI.add_argument("--hypertuning", type=str, default="first", choices=["first", "full", "no"])
    args = CLI.parse_args()
    ...
    print("=============================================================================")
    print("Dataset: %s, Sampling Method: %s, Hypertuning: %s" % (DATASET, METHOD, hypertuning))
    print("=============================================================================")
    ...
    results = []
    for cid, (e, b) in enumerate(configs):
        print("--------------------------------------")
